...
// Source: pkg/domain/repository/user/infra.go
...
func (m *MockRepository) InsertUser(ctx context.Context, masterTx repository.MasterTx, uid, name, thumbnail string) (*entity.User, error) {
	m.ctrl.T.Helper()
